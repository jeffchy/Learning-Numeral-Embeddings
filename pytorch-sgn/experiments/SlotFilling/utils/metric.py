...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    ...
    for idx in range(0,sent_num):
        ...
        elif label_type == "NoSeg":
            gold_matrix = get_ner_NONE(golden_list)
            pred_matrix = get_ner_NONE(predict_list)
        else: # BIO
