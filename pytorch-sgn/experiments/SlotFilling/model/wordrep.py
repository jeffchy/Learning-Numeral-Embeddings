...
class WordRep(nn.Module):
    def __init__(self, data):
        ...
        # we only need to modify this part
        self.embedding_dim = data.word_emb_dim
        self.drop = nn.Dropout(data.HP_dropout)
        self.word_embedding = nn.Embedding(data.word_alphabet.size(), self.embedding_dim)
        self.word_embedding.weight.requires_grad = data.train_embedding
        ...
        # does not matter, we do not use feature, just make sure feature_num = 0
