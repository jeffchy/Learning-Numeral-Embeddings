...
import argparse
from model import ListMax, CNN, TransformerModel, MLP, MLP3Diff, BiLinearDiff1, BiLinearDiffH
import pickle
import numpy as np
import random
import logging
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_epoch', type=int, default=200, help="num epoch")
    ...
    parser.add_argument('--model', type=str, default='MLP', help="model, should be in, MLP3, MLP, BiLinear, BiLinearH")
    parser.add_argument('--gamma', type=float, default=1.0, help="gamma for LR schedule")
    parser.add_argument('--run', type=str, default='MLP1Diff', help="MLP1Diff, MLP3Diff, BiLinearDiff1, BiLinearDiff3")
    parser.add_argument('--lr_tune', type=str, default='0.3:1:3:10', help="tune LR")
    ...
    parser.add_argument('--dataset_dir', type=str, default='highnolog', help='highnolog, lownolog')
    ...
    assert args.model in ['MLP', 'MLP3', 'BiLinear', 'BiLinearH']
