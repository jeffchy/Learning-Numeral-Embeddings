...
class Evaluator(object):
    ...
    def _get_score(self, i):
        ...
        for c in i[1]:
            try:
                ...
                elif '<UNK_W>' in self.word2idx:
                    wordvec = self.idx2vec_o[self.word2idx['<UNK_W>']]
            ...
            try:
                ...
                if '<UNK>' in self.word2idx:
                    ...
                    wordvec = self.idx2vec_i[self.word2idx['<UNK_W>']]
    ...
    def load_prototype(self,
        ...
        self.norms, _ = self.compute_norm_factor_all()
